                    ...
                    <?php } else { ?>
                        <div class="dropdown d-none d-lg-block">
                            ...
                            <ul class="dropdown-menu" style='min-width: 220px;'>
                                ...
                                <li><a class="dropdown-item d-flex gap-3 align-items-center" href="<?php base_url('requests') ?>"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="retweet" class="svg-inline--fa fa-retweet w-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="18" height="18">
