...
$sql = "SELECT * FROM product_request WHERE user_id = $user_id AND status=3 ORDER BY id DESC";
        ...
        <div class='mt-1 d-flex flex-column '>
            ...
            <div class='px-2 border-bottom py-4 d-flex gap-4 '>
               ...
               ?>
                ...
                ?></p>
                <p class='f-15'><strong>Message from DozKart:</strong> This product cannot be approved. Please contact customer support</p>
               </div>
            </div>
            <?php } ?>
        </div>
