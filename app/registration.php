        ...
        <div class="row justify-content-center ">
            <div class="col-xl-5 col-md-6">
                <div class="card border-0 align-items-center d-flex flex-column " style='padding: 38px 1.5rem;'>
                    <h2 style='font-weight: 600;font-size:25px;color:var(--black)' class='mb-4'>Create a Account</h2>
                    <form action="<?php base_url('process-registration') ?>" class="w-100" method="post">
                        <input type="text" placeholder="Full Name" name="name" class='form-control mb-3 <?php echo formError('name')!=false?'border-danger':'' ?>' value="<?php  old_value('name') !== false ? old_value('name') : ''; ?>" required>

                        <input type="number" class="form-control mb-3 <?php echo formError('phone')===false ?'we':'border-danger' ?>" placeholder="Phone" name="phone" id="phone_num" required value="<?php  old_value('phone') !== false ? old_value('phone') : ''; ?>">
                        ...
                        <input type="password" class="form-control mb-3 password-show-hide <?php echo formError('password')!=false?'border-danger':'' ?>" placeholder="Password" name="password"  value="<?php  old_value('password') !== false ? old_value('password') : ''; ?>" required>
                   ...
                   <div class="border py-1 hover-bg-gray" style="background-color: #f6f6f6;width:fit-content;font-size:14px">
                    ...
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="LgbsSe-Bz112c" width="18" height="18">
  <g>
...
Continue with Facebook
                        ...
                        <input type="submit" name='submit_registration' class='btn btn-primary d-block w-100 mt-4 py-2 mb-2'>
                    </form>
                    <span><a href="<?php base_url('login') ?>" class='text-primary ' style='font-size:15px'>Log In</a></span>
                </div>
            </div>
        </div>
    </div>
