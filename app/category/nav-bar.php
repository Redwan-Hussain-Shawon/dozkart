            ...
            <form id="filterForm" method="get">
                ...
                <div class="border-bottom" style="padding:13px 16px">
                    ...
                    <div class="d-flex gap-2 justify-content-center align-items-center mt-2">
                        <select name="min-price" class="border p-1 w-100 outline-none f-14" id='min-price'>
                        ...
                        to
                        <select name="max-price" class="border p-1 w-100 outline-none f-14" id='max-price'>
                    ...
                    <div class=" " style="margin-top: 11px;">
                        <div class="d-flex flex-column gap-3">
                            <label for="3jar" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check" id="3jar" value="3 Jar" name="size" value='3 Jar'>
                            ...
                            <label for="4jar" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check " id="4jar" value="4 Jar" name="size">
                    ...
                    <div class="collapse " style="margin-top: 11px;">
                        <div class="d-flex flex-column gap-3">
                            <label for="black" class="d-flex align-items-center gap-2 ">
                                <input type="checkbox" class="form-check" id="black" value="Black" name='color'>
                            ...
                            <label for="red" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check " id="red" value="Red" name="color">
                ...
                <div class="border-bottom " style="padding:13px 16px">
                    ...
                    <div class="collapse " style="margin-top: 11px;">
                        <div class="d-flex flex-column gap-3">
                            <label for="rating5" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check " id="rating5" value="4" name="ratting">
                                <h5 class="text-black mb-0  f-14 fw-normal pointer hover-primary">5★★★★★</h5>
                            </label>
                            <label for="rating4" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check " id="rating4" value="4" name="ratting">
                                <h5 class="text-black mb-0 f-14 fw-normal pointer hover-primary">4★★★★</h5>
                            </label>
                            <label for="rating3" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check" id="rating3" value="3" name="ratting">
                                <h5 class="text-black mb-0  f-14 fw-normal pointer hover-primary">3★★★</h5>
                            </label>

                            <label for="rating2" class="d-flex align-items-center gap-2 pointer">
                                <input type="checkbox" class="form-check " id="rating2" value="White" name="ratting">
                                <h5 class="text-black mb-0  f-14 fw-normal pointer hover-primary">2★★ </h5>
                            </label>
                ...
                <div class="d-flex mt-3">
                    ...
                    <button class="btn btn-primary w-100" style="border-radius: 2px;" onclick="filterSubmit()" type="button">Submit</button>
                </div>
