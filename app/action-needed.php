...
$user_id = getId();
$sql = "SELECT * FROM action_needed WHERE user_id=$user_id ORDER BY id DESC LIMIT 30";
                                    ...
                                    <div class='px-2 border-bottom py-2 d-flex gap-4 '>
                                        <div class='bg-light rounded border' style='width: 96px;height:96px'>
                                            <?php if (!empty($data['img'])) { ?>
                                                <img src="<?php base_url('assets/images/request/' . $data['img']) ?>" alt="" class="w-100 h-100">
                                            <?php } ?>
                                        </div>
                            ...
                            <div class='d-flex flex-column flex-md-row justify-content-center align-items-center py-5' style="row-gap: 30px;column-gap:80px">
                                ...
                                <div class="">
                                    <div>
                                        ...
                                        <h3 class="text-base fw-normal h6 tracking-twenty text-pcolor-light text-paragraph text-center text-md-start">You don't have any action yet.</h3>
                                    </div>
